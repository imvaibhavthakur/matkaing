...
const Single = () => {
  ...
  const handlePointChange = (number: number, value: string) => {
  ...
  const handleSubmit = () => {
    console.log("Submitting game with points:", points);
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2">SINGLE (10 KA 100)</h1>
